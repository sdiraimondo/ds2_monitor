...
// por um input, depois de reescrever v·rias vezes, o mÈtodo de utilizar
// uma thread pra fazer o polling e enviar uma mensagem WM_USER pra janela,
// ÅEsimplesmente perfeito, n„o sÅEisso, podemos tambÈm fazer o timeout facilmente.
// Uma vez que a funÁ„o do Dialogo mesmo ÅEsÅEretornar o valor do input, nossa thread
